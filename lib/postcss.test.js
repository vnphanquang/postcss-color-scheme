...
test('in deep nested selector', async () => {
...
test('has child rules', async () => {
  const input = readCSS('./tests/has-child-rules.input.css');
  const output = readCSS('./tests/has-child-rules.output.css');
